...
//linking into the accounting, to use accounting functions.
...
//Printing the Number 1 - 20 to the page.
var printingNumbers = function (req, res, next) {
    res.writeHead(200, {
        'Content-Type': 'text-plain'
    });
    for (var i = 1; i <= 20; i++) {
...
app.use('/printing', printingNumbers);
app.use('/',  home);
